...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateIncrement) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateIncrement');
    }
    this.witnesses = witnesses_0;
    this.circuits = {
      isAllowedIncrement(context, ...args_1) {
        return { result: pureCircuits.isAllowedIncrement(...args_1), context };
      },
      increment: (...args_1) => {
        if (args_1.length !== 1) {
  ...
  _isAllowedIncrement_0(value_0) { return value_0 >= 1n && value_0 <= 10n; }
  _increment_0(context, partialProofData) {
    const secretValue_0 = this._privateIncrement_0(context, partialProofData);
    const accepted_0 = this._isAllowedIncrement_0(secretValue_0);
    __compactRuntime.assert(accepted_0,
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(accepted_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
...
export const pureCircuits = {
  isAllowedIncrement: (...args_0) => {
    if (args_0.length !== 1) {
      throw new __compactRuntime.CompactError(`isAllowedIncrement: expected 1 argument (as invoked from Typescript), received ${args_0.length}`);
    }
    const value_0 = args_0[0];
    if (!(typeof(value_0) === 'bigint' && value_0 >= 0n && value_0 <= 65535n)) {
      __compactRuntime.typeError('isAllowedIncrement',
                                 'argument 1',
                                 'counter.compact line 20 char 1',
                                 'Uint<0..65536>',
                                 value_0)
    }
    return _dummyContract._isAllowedIncrement_0(value_0);
  }
};
